...
export const VOCABULARY: Record<string, VocabWord> = {
  ...
  siapa_nama_arab: V("siapa_nama_arab", "مَا اسْمُكَ؟ (Maa ismuka? - untuk laki-laki) / مَا اسْمُكِ؟ (Maa ismuki? - untuk perempuan)", "Arab", "Siapa nama Anda?", "Siape nama ente?", "", "common"),
  ...
  dari_mana_arab: V("dari_mana_arab", "مِنْ أَيْنَ أَنْتَ؟ (Min ayna anta? - untuk laki-laki) / مِنْ أَيْنَ أَنْتِ؟ (Min ayna anti? - untuk perempuan)", "Arab", "Dari mana Anda berasal?", "Ente asalnya dari mane?", "", "common"),
  ...
  berapa_usia_arab: V("berapa_usia_arab", "كَمْ عُمْرُكَ؟ (Kam 'umruka? - untuk laki-laki) / كَمْ عُمْرُكِ؟ (Kam 'umruki? - untuk perempuan)", "Arab", "Berapa usia Anda?", "Umur ente berape?", "", "common"),
  ...
  kamu_arab: V("kamu_arab", "أَنْتَ (Anta - untuk laki-laki) / أَنْتِ (Anti - untuk perempuan)", "Arab", "Anda/Kamu", "Ente/Lu", "", "common"),
  ...
  // No. 18 — Kakek
  kakek_arab: V("kakek_arab", "جَدِّي (Jaddii)", "Arab", "Kakek", "Engkong", "", "common"),
  kakek_belanda: V("kakek_belanda", "Opa", "Belanda", "Kakek", "Engkong", "", "common"),
  kakek_tiongkok: V("kakek_tiongkok", "爷爷 (Yéye - kakek dari ayah)", "Tiongkok", "Kakek", "Engkong", "", "common"),
  ...
  // No. 19 — Nenek
  nenek_arab: V("nenek_arab", "جَدَّتِي (Jaddatii)", "Arab", "Nenek", "Nyai", "", "common"),
  nenek_belanda: V("nenek_belanda", "Oma", "Belanda", "Nenek", "Nyai", "", "common"),
  nenek_tiongkok: V("nenek_tiongkok", "奶奶 (Nǎinǎi - nenek dari ayah)", "Tiongkok", "Nenek", "Nyai", "", "common"),
  ...
  // No. 20 — Kakak
  kakak_arab: V("kakak_arab", "أَخِي (Akhii - laki-laki) / أُخْتِي (Ukhtii - perempuan)", "Arab", "Kakak", "Abang/Mpok", "", "common"),
  kakak_belanda: V("kakak_belanda", "Broer/Zus", "Belanda", "Kakak", "Abang/Mpok", "", "common"),
  kakak_tiongkok: V("kakak_tiongkok", "哥哥 (Gēge - laki-laki) / 姐姐 (Jiějie - perempuan)", "Tiongkok", "Kakak", "Abang/Mpok", "", "common"),
  ...
  // No. 21 — Adik
  adik_arab: V("adik_arab", "أَخِي (Akhii - laki-laki) / أُخْتِي (Ukhtii - perempuan)", "Arab", "Adik", "Ade", "", "common"),
  adik_belanda: V("adik_belanda", "Broertje/Zusje", "Belanda", "Adik", "Ade", "", "common"),
  adik_tiongkok: V("adik_tiongkok", "弟弟 (Didi - laki-laki) / 妹妹 (Mèimei - perempuan)", "Tiongkok", "Adik", "Ade", "", "common"),
  ...
  // No. 22 — Paman
  paman_arab: V("paman_arab", "أَمِّي (Ammii)", "Arab", "Paman", "Encang/Om", "", "common"),
  paman_belanda: V("paman_belanda", "Oom", "Belanda", "Paman", "Encang/Om", "", "common"),
  paman_tiongkok: V("paman_tiongkok", "舅舅 (Jiùjiu)", "Tiongkok", "Paman", "Encang/Om", "", "common"),
  ...
  // No. 23 — Bibi
  bibi_arab: V("bibi_arab", "أَمَّاتِي (Ammatii)", "Arab", "Bibi", "Encing/Tante", "", "common"),
  bibi_belanda: V("bibi_belanda", "Tante", "Belanda", "Bibi", "Encing/Tante", "", "common"),
  bibi_tiongkok: V("bibi_tiongkok", "阿姨 (Āyí)", "Tiongkok", "Bibi", "Encing/Tante", "", "common"),
  ...
  // TIONGKOK — Feng
  angpao: V("angpao",  "紅包 hóng bāo", "Tiongkok", "Amplop merah berisi uang", "Angpao — amplop berisi uang hadiah", "“Pas Imlek anak-anak nungguin angpao dari om.”", "advance"),
